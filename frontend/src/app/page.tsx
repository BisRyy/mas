  ...
  return (
    <div className="space-y-8">
      <header className="space-y-1">
        <h1 className="text-3xl font-bold tracking-tight">Inventory MAS</h1>
        <p className="text-ink-muted">
          Tracking and analytics console for the multi-agent inventory thesis.
          {families.data && (
            <span className="ml-2">
              {Object.values(families.data).reduce((a, b) => a + b, 0)} experiments
              in the catalog.
            </span>
          )}
        </p>
